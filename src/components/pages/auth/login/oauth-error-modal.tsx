...
function getErrorConfig(errorType: string, customMessage: string | null) {
  const configs: Record<string, {
    ...
    subscription_canceled: {
      ...
      description: customMessage || "Your subscription has been canceled. Please subscribe to a plan to access EditDeckPro.",
      details: "Visit our pricing page to subscribe to a plan and regain access to all features.",
      showPricingButton: true,
      icon: "cancel",
    ...
    subscription_inactive: {
      ...
      description: customMessage || "Your subscription is inactive. Please subscribe to a plan to access EditDeckPro.",
      details: "Visit our pricing page to subscribe to a plan and access all features.",
      showPricingButton: true,
      icon: "pause_circle",
